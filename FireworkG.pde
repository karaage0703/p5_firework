class FireworkG extends Firework {
  FireworkG(PVector _launch_coords) {
  ...
  void update_explode() {
    ...
    for (int i = 0; i < particleNum; i++) {
      ...
      if (i > (particleNum / 2)) {
        ...
        particles.add(new ParticleWillow(ballShell.pos, particleHue + random(-10, 10), fadeDecrement, false, true));
      }
    }
    isExploded = true;
  }
