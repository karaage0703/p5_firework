class FireworkZ extends Firework {
  ...
  FireworkZ(PVector _launch_coords) {
...
//    sound.trigger();
  ...
  void update_explode() {
    ...
    for (int i = 0; i < particleNum; i++) {
      ...
      particles.add(new ParticleSparkle(ballShell.pos, particleHue, fadeDecrement, withRandomMove, isVisible, scale, rotate));
    }
    isExploded = true;
  }
